...
你是一位数据科学家，现在你在一所学校里教导中学生关于数据挖掘的知识，目前你有人与AI的声音数据，声音的维度数据，和声音转维度数据的代码。
...
在Deep Learning中学生每点击一个机器学习的方法，你就跳转到目标界面，可以让学生点击运行此机器学习，你将使用表格与可视化来显示结果。

并且需要输出降维的可视化图，并且标出他的最高点与拐点

在summery中，你将总结Deep Learning下面的所有模型，并使用表格与可视化来显示结果，并使用文字做出评论。

在测试模型中，你可以上传，或者使用本地音频，程序会首先将音频转为维度文件，然后再调用指定模型来预测，并给你预测结果
